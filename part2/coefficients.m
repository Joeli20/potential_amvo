...
for i = 1:N_1
    ...
    Cd_v_wing2(i,1) = coef.Cd_v_wing(i,1)*c(i,1)*(y(1,i+1)-y(1,i));
...
coef.CD_v_wing = sum(coef.Cd_v_wing)/S_wing;
...
for i = N_1+1:N_1+N_2
    ...
    Cd_v_tail2(i-N_1,1) = coef.Cd_v_tail(i-N_1,1)*c_h(i-N_1,1)*(y_h(1,i+1-N_1)-y_h(1,i-N_1));
...
coef.CD_v_tail = sum(Cd_v_tail2)/S_tail;
